...
class TestAuthorization(unittest.TestCase):
    ...
    def test_getUrl(self):
        self.assertEqual(self.auth.auth_url, "https://" + os.environ.get("AUTH_URI") + "/connect/token")

    def test_getClientID(self):
        self.assertEqual(self.auth.client_id, os.environ.get("CLIENT_ID"))

    def test_getClientSecret(self):
        self.assertEqual(self.auth.client_secret, os.environ.get("CLIENT_SECRET"))
